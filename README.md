...
packet-svc-auth-forge is a Kotlin project for backend services. It focuses on this technical goal: Design a Kotlin verification harness for auth systems, covering incremental indexing, append-only fixtures, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 166, risk penalty 6, latency penalty 4, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
